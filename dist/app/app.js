...
`<div class="zoomed-pic-container">
    <img class="zoomed-pic" src="${imageName}" alt="zoomed-image">
</div>
...
const initPhotoZoom = (imagePathParameter) =>  {
    const gallery = document.querySelector('.gallery');
    const backgroundHtmlNode = document.createElement('div');

    displayPhoto(gallery, imagePathParameter, backgroundHtmlNode);
}

const displayPhoto = (galleryParameter, imagePathParameter, backgroundHtmlNodeParameter) => {
    backgroundHtmlNodeParameter.innerHTML = backgroundHtml(imagePathParameter);
